...
dgp_configs <- list(
  list(mu = mu_linear, tau = tau_homogeneous, label = "linear_mu_homog_tau"),
  list(mu = mu_linear, tau = tau_heterogeneous, label = "linear_mu_heterog_tau"),
  list(mu = mu_nonlinear, tau = tau_homogeneous, label = "nonlinear_mu_homog_tau"),
  list(mu = mu_nonlinear, tau = tau_heterogeneous, label = "nonlinear_mu_heterog_tau")
)
